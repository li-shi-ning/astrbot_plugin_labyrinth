...
FIXED_TILES: dict[tuple[int, int], tuple[str, int, str | None, str | None]] = {
    ...
    (0, 2): ("t-shape", 1, "KnightHelmet", None),
    (0, 4): ("t-shape", 1, "Candles", None),
    (0, 6): ("corner", 2, None, "red"),
    (2, 0): ("t-shape", 0, "Dagger", None),
    (2, 2): ("t-shape", 0, "Diamond", None),
    (2, 4): ("t-shape", 1, "Treasure", None),
    (2, 6): ("t-shape", 2, "Ring", None),
    (4, 0): ("t-shape", 0, "HolyGrail", None),
    (4, 2): ("t-shape", 3, "Keys", None),
    (4, 4): ("t-shape", 2, "Crown", None),
    (4, 6): ("t-shape", 2, "Potion", None),
    (6, 0): ("corner", 0, None, "green"),
    (6, 2): ("t-shape", 3, "Coins", None),
